...
func (m *GreetTimesRequest) Reset()         { *m = GreetTimesRequest{} }
func (m *GreetTimesRequest) String() string { return proto.CompactTextString(m) }
func (*GreetTimesRequest) ProtoMessage()    {}
func (*GreetTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe6f881da19a2871, []int{3}
}

func (m *GreetTimesRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GreetTimesRequest.Unmarshal(m, b)
}
func (m *GreetTimesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GreetTimesRequest.Marshal(b, m, deterministic)
}
func (m *GreetTimesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GreetTimesRequest.Merge(m, src)
}
func (m *GreetTimesRequest) XXX_Size() int {
	return xxx_messageInfo_GreetTimesRequest.Size(m)
}
func (m *GreetTimesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GreetTimesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GreetTimesRequest proto.InternalMessageInfo

func (m *GreetTimesRequest) GetGreeting() *Greeting {
	if m != nil {
		return m.Greeting
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GreetTimesRequest)(nil), "greet.GreetTimesRequest")
...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	0x80, 0xf2, 0x94, 0x1c, 0xb8, 0x04, 0xc1, 0x0a, 0x43, 0x32, 0x73, 0x53, 0x8b, 0xc9, 0xb2, 0xca,
	0x80, 0x4b, 0x0c, 0x2c, 0xea, 0x9b, 0x98, 0x57, 0x09, 0x35, 0x05, 0xbf, 0x9d, 0x46, 0x93, 0x19,
	0xa1, 0x5e, 0x0b, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x15, 0x32, 0xe1, 0x62, 0x05, 0xf3, 0x85,
	0x84, 0x91, 0xad, 0x81, 0xba, 0x46, 0x4a, 0x04, 0x55, 0x10, 0x62, 0xb8, 0x12, 0x83, 0x90, 0x2f,
	0x17, 0x1f, 0xdc, 0xe2, 0x12, 0x90, 0xc5, 0x42, 0x12, 0xc8, 0x2a, 0x91, 0x7d, 0x24, 0x25, 0x8b,
	0x2c, 0x83, 0xe1, 0x52, 0x25, 0x06, 0x03, 0x46, 0x27, 0xce, 0x28, 0x76, 0x68, 0xac, 0x26, 0xb1,
	0x81, 0x23, 0xd4, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xc9, 0x6b, 0x0a, 0x5e, 0xed, 0x01, 0x00,
	0x00,
}
...
type GreetServiceClient interface {
	...
	//Server Streaming
	GreetManytimes(ctx context.Context, in *GreetTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManytimesClient, error)
}
...
func (c *greetServiceClient) GreetManytimes(ctx context.Context, in *GreetTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManytimesClient, error) {
...
type GreetServiceServer interface {
	...
	//Server Streaming
	GreetManytimes(*GreetTimesRequest, GreetService_GreetManytimesServer) error
}
